<a style="text-decoration:none; font-size:18px; margin:20px; font-weight:bold; color: white" href="<?php echo URL::base(); ?>">На сайт</a>
<style>
body { background:#666 url(/media/images/poster-image.jpg) no-repeat top;}
</style>
