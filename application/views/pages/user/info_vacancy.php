                        ...
                        <div class="post-control_center row">
                            <div class="col-xs-12">
                                ...
                                <div class="data" style="width: 120px; margin-left: 25px">
                                    <?php if($v['active'] == 1):?>
                                    <p><a href="/vacancy/cv/<?php echo $v['id'];?>">Ваша вакансия размещена</a></p>
                                    <?php  elseif($v['active'] == 2):?>
                                        <p>Ваше объявление заблокировано ! Свяжитесь с администратором.</p>
                                    <?php elseif($v['active'] == 3):?>
                                        <p>Ваше объявление не показывается на сайте</p>
                                        <?php else:?>
                                        <p>На модерации</p>
                                    <?php endif; ?>
                                </div>
