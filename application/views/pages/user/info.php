                ...
                <div class="col-xs-7">
                    <div class="find_work">
                        <div>
                            ...
                            <small>Например: охранник</small>
                        </div>
                        <div>
                            <select class="input_width"  name="name[]">
                                <option>Австрия</option>
                                <option>Бельгия</option>
                                <option>Болгария</option>
                                <option>Великобритания</option>
                        ...
                        <div>
                            ...
                            <small> Категории (до троих) </small>
                        </div>
                        <div>
                            <select class="input_width">
                                <option>от 1 дня до 3 месяцев</option>
                                <option>от 3 месяцев до 6 месяцев</option>
                                <option>от полугода к году</option>
                            </select>
                            <small> Актуальность </small>
                        </div>
